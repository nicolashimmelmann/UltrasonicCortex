...
OPENOCD_INTERFACE = PLEASE_INSERT_INTERFACE_CONFIG

# ============================================
# probably no changes required below this line
# ============================================
...
# C++ specific options here (added to USE_OPT).
ifeq ($(USE_CPPOPT),)
  USE_CPPOPT = -fno-rtti -fno-exceptions --specs=nosys.specs
endif
...
ifeq ($(USE_PROCESS_STACKSIZE),)
  # change PROCESS and EXCEPTIONS from 0x400 to 0x1000 ~jl
...
CC   = $(TRGT)gcc
CPPC = $(TRGT)g++
LD   = $(TRGT)g++ $(USE_CPPOPT) $(USE_OPT) -Wl,--gc-sections
CP   = $(TRGT)objcopy
...
flash:
	openocd -f $(OPENOCD_INTERFACE) \
		-c "program build/$(PROJECT).elf verify" -c "reset halt" -c "wait_halt" -c "poll" -c "exit"
