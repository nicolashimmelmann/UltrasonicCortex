...
#define BOARD_NAME                  "ESA board (v4)"
...
#define GPIOA_BT_SYSTEM_OUT         7U
#define GPIOA_M3_CTRL               8U
#define GPIOA_M4_CTRL               9U
#define GPIOA_M2_CTRL               10U
#define GPIOA_M1_CTRL               11U
#define GPIOA_GPIO_10               12U
#define GPIOA_SWDAT                 13U
#define GPIOA_SWCLK                 14U
#define GPIOA_GPIO_9                15U

#define GPIOB_LED0_RED              0U
#define GPIOB_LED1_GREEN            1U
#define GPIOB_STICK_CENTER          2U
#define GPIOB_USART5_TX             3U
#define GPIOB_USART5_RX             4U
#define GPIOB_GPIO_3                5U
#define GPIOB_GPIO_2                6U
#define GPIOB_GPIO_5                7U
#define GPIOB_I2C1_SCL              8U
#define GPIOB_I2C1_SDA              9U
#define GPIOB_STICK_RIGHT           10U
#define GPIOB_STICK_UP              11U
#define GPIOB_STICK_LEFT            12U
#define GPIOB_STICK_DOWN            13U
#define GPIOB_GPIO_1                14U
...
#define GPIOC_GPIO_4                13U
#define GPIOC_GPIO_7                14U
...
#define GPIOF_GPIO_6                0U
#define GPIOF_GPIO_8                1U
...
#define LINE_BT_SYSTEM_OUT          PAL_LINE(GPIOA, 7U)
#define LINE_M3_CTRL                PAL_LINE(GPIOA, 8U)
#define LINE_M4_CTRL                PAL_LINE(GPIOA, 9U)
#define LINE_M2_CTRL                PAL_LINE(GPIOA, 10U)
#define LINE_M1_CTRL                PAL_LINE(GPIOA, 11U)
#define LINE_GPIO_10                PAL_LINE(GPIOA, 12U)
#define LINE_SWDAT                  PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK                  PAL_LINE(GPIOA, 14U)
#define LINE_GPIO_9                 PAL_LINE(GPIOA, 15U)

#define LINE_LED0_RED               PAL_LINE(GPIOB, 0U)
#define LINE_LED1_GREEN             PAL_LINE(GPIOB, 1U)
#define LINE_STICK_CENTER           PAL_LINE(GPIOB, 2U)
#define LINE_USART5_TX              PAL_LINE(GPIOB, 3U)
#define LINE_USART5_RX              PAL_LINE(GPIOB, 4U)
#define LINE_GPIO_3                 PAL_LINE(GPIOB, 5U)
#define LINE_GPIO_2                 PAL_LINE(GPIOB, 6U)
#define LINE_GPIO_5                 PAL_LINE(GPIOB, 7U)
#define LINE_I2C1_SCL               PAL_LINE(GPIOB, 8U)
#define LINE_I2C1_SDA               PAL_LINE(GPIOB, 9U)
#define LINE_STICK_RIGHT            PAL_LINE(GPIOB, 10U)
#define LINE_STICK_UP               PAL_LINE(GPIOB, 11U)
#define LINE_STICK_LEFT             PAL_LINE(GPIOB, 12U)
#define LINE_STICK_DOWN             PAL_LINE(GPIOB, 13U)
#define LINE_GPIO_1                 PAL_LINE(GPIOB, 14U)
#define LINE_GPIO_0                 PAL_LINE(GPIOB, 15U)

#define LINE_GPIO_4                 PAL_LINE(GPIOC, 13U)
#define LINE_GPIO_7                 PAL_LINE(GPIOC, 14U)
#define LINE_BT_SYSTEM_KEY          PAL_LINE(GPIOC, 15U)


#define LINE_GPIO_6                 PAL_LINE(GPIOF, 0U)
#define LINE_GPIO_8                 PAL_LINE(GPIOF, 1U)
 ...
 * PA6  - LIGHT                     (analog).
 * PA7  - BT_SYSTEM_OUT             (input floating).
 * PA8  - M3_CTRL                   (output pushpull minimum).
 * PA9  - M4_CTRL                   (output pushpull minimum).
 * PA10 - M2_CTRL                   (output pushpull minimum).
 * PA11 - M1_CTRL                   (output pushpull minimum).
 * PA12 - GPIO_10                   (output pushpull minimum).
 * PA13 - SWDAT                     (alternate 0).
 * PA14 - SWCLK                     (alternate 0).
 * PA15 - GPIO_9                    (output pushpull minimum).
 */
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_USART2_CTS) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_BT_SYSTEM_OUT) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_GPIO_10) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWDAT) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWCLK) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_GPIO_9))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_USART2_CTS) | \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_BT_SYSTEM_OUT) | \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_GPIO_10) |    \
                                     PIN_OSPEED_HIGH(GPIOA_SWDAT) |         \
                                     PIN_OSPEED_HIGH(GPIOA_SWCLK) |         \
                                     PIN_OSPEED_VERYLOW(GPIOA_GPIO_9))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_USART2_CTS) | \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_BT_SYSTEM_OUT) |\
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_GPIO_10) |    \
                                     PIN_PUPDR_PULLUP(GPIOA_SWDAT) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOA_SWCLK) |      \
                                     PIN_PUPDR_PULLDOWN(GPIOA_GPIO_9))
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_USART2_CTS, 1U) |    \
                                     ...
                                     PIN_AFIO_AF(GPIOA_BT_SYSTEM_OUT, 0U))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_M3_CTRL, 2U) |       \
                                     PIN_AFIO_AF(GPIOA_M4_CTRL, 2U) |       \
                                     PIN_AFIO_AF(GPIOA_M2_CTRL, 2U) |       \
                                     PIN_AFIO_AF(GPIOA_M1_CTRL, 2U) |       \
                                     PIN_AFIO_AF(GPIOA_GPIO_10, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_SWDAT, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_SWCLK, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_GPIO_9, 0U))

/*
 * GPIOB setup:
 *
 * PB0  - LED0_RED                  (output pushpull minimum).
 * PB1  - LED1_GREEN                (output pushpull minimum).
 * PB2  - STICK_CENTER              (input pullup).
 * PB3  - USART5_TX                 (alternate 4).
 * PB4  - USART5_RX                 (alternate 4).
 * PB5  - GPIO_3                    (output pushpull minimum).
 * PB6  - GPIO_2                    (output pushpull minimum).
 * PB7  - GPIO_5                    (output pushpull minimum).
 * PB8  - I2C1_SCL                  (alternate 1).
 * PB9  - I2C1_SDA                  (alternate 1).
 * PB10 - STICK_RIGHT               (input pullup).
 * PB11 - STICK_UP                  (input pullup).
 * PB12 - STICK_LEFT                (input pullup).
 * PB13 - STICK_DOWN                (input pullup).
 * PB14 - GPIO_1                    (output pushpull minimum).
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_LED0_RED) |   \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_GPIO_2) |     \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOB_LED0_RED) |   \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOB_GPIO_2) |     \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOB_LED0_RED) |   \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOB_GPIO_2) |     \
 ...
 * PC13 - GPIO_4                    (output pushpull minimum).
 * PC14 - GPIO_7                    (output pushpull minimum).
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_GPIO_4) |     \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOC_GPIO_4) |     \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOC_GPIO_4) |     \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PIN0) |             \
                                     ...
                                     PIN_ODR_LOW(GPIOC_GPIO_4) |            \
                                     PIN_ODR_LOW(GPIOC_GPIO_7) |            \
                                     PIN_ODR_HIGH(GPIOC_BT_SYSTEM_KEY))
 ...
 * GPIOF setup:
 *
 * PF0  - GPIO_6                    (output pushpull minimum).
 * PF1  - GPIO_8                    (output pushpull minimum).
 ...
 */
#define VAL_GPIOF_MODER             (PIN_MODE_OUTPUT(GPIOF_GPIO_6) |        \
                                     PIN_MODE_OUTPUT(GPIOF_GPIO_8) |        \
...
#define VAL_GPIOF_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOF_GPIO_6) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOF_GPIO_8) |     \
...
#define VAL_GPIOF_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOF_GPIO_6) |     \
                                     PIN_OSPEED_VERYLOW(GPIOF_GPIO_8) |     \
...
#define VAL_GPIOF_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOF_GPIO_6) |     \
                                     PIN_PUPDR_PULLDOWN(GPIOF_GPIO_8) |     \
...
#define VAL_GPIOF_ODR               (PIN_ODR_LOW(GPIOF_GPIO_6) |            \
                                     PIN_ODR_LOW(GPIOF_GPIO_8) |            \
...
#define VAL_GPIOF_AFRL              (PIN_AFIO_AF(GPIOF_GPIO_6, 0U) |        \
                                     PIN_AFIO_AF(GPIOF_GPIO_8, 0U) |        \
